...
public class percobaan3 {
    public static void main(String[] args) {
        ...
        String matkulGradeKualifikasi[][] = {{"Pancasila", "", ""}, {"Konsep Tenologi Informasi", "", ""}, {"Critical Thinking dan Problem Solving", "", ""}, {"Matematika Dasar", "", ""}, {"Bahasa Inggris", "", ""}, {"Dasar Pemrograman", "", ""}, {"Praktikum Dasar Pemrograman", "", ""}, {"Keselamatan Dan Kesehatan Kerja", "", ""}};
